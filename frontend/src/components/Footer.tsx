        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-3 space-y-6">
            ...
            <div className="flex items-center space-x-6 pt-2">
              <a href="https://www.instagram.com/galletrix_innovations?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors duration-200" aria-label="Instagram">
              ...
              <a href="https://wa.me/917305870929" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors duration-200" aria-label="WhatsApp">
              ...
              <a href="https://x.com/galletrix" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors duration-200" aria-label="X (Twitter)">
