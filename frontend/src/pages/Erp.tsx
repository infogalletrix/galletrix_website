...
const Erp: React.FC<ErpProps> = ({ navigateToContact }) => {
  return (
    <>
      {/* ERP Solutions Page */}
      <section id="erp" className="w-full bg-black mt-24 min-h-[calc(100vh-6rem)] flex flex-col justify-center items-center py-12 animate-fade-in">
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            <span className="font-sans text-[15px] sm:text-[16px] font-semibold text-white tracking-wide mb-6">
              Galletrix Service
            </span>
            
            <h1 className="scroll-reveal-target font-serif text-[44px] sm:text-[56px] md:text-[72px] font-semibold leading-[1.1] text-white tracking-tight mb-8">
              ERP Solutions
            </h1>
            
            <h2 className="scroll-reveal-target font-sans text-[18px] sm:text-[21px] md:text-[23px] font-semibold text-white mb-6 leading-snug">
              Manage every business operation in one place
            </h2>
            
            <p className="scroll-reveal-target font-sans text-[15px] sm:text-[17px] leading-[1.75] text-white max-w-xl">
      ...
      <section id="erp-page-2" className="w-full bg-gradient-to-b from-[#000000] to-black py-16 md:py-32 lg:py-40 border-t border-slate-900/60 min-h-screen flex items-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 w-full mb-32 items-start">
            <div className="flex flex-col items-start text-left">
              ...
              <h2 className="scroll-reveal-target font-serif text-[42px] sm:text-[52px] font-medium leading-[1.15] text-white tracking-tight">
                What We <span className="text-white font-semibold">Deliver</span>
              </h2>
            </div>
            <div className="text-left">
              <p className="scroll-reveal-target font-sans text-[16px] sm:text-[17px] leading-[1.8] text-white max-w-2xl">
      ...
      <section id="erp-page-3" className="w-full bg-black py-16 md:py-32 lg:py-40 border-t border-slate-900/60 min-h-screen flex items-center">
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full flex flex-col justify-between items-center animate-fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl mb-36">
            {[
              ...
              <div 
                key={i} 
                className="border border-white/20 bg-black px-6 py-5 rounded-[18px] flex items-center gap-4 hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300"
              >
