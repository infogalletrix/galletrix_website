...
const Automation: React.FC<AutomationProps> = ({ navigateToContact }) => {
  return (
    <>
      ...
      <section id="automation" className="w-full bg-black mt-24 py-12 flex flex-col justify-center min-h-[calc(100vh-6rem)]">
      ...
      <section id="automation-page-2" className="w-full bg-black min-h-[calc(100vh-6rem)] py-12 border-t border-slate-900/60 flex flex-col justify-center items-center">
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full flex flex-col items-center animate-fade-in">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 mb-32">
            <div className="lg:col-span-4 flex flex-col">
              ...
              <h2 className="scroll-reveal-target font-serif text-[42px] sm:text-[48px] font-medium leading-[1.15] text-white tracking-tight">
                What We <span className="text-white">Deliver</span>
              </h2>
            </div>
            <div className="lg:col-span-8 flex items-center">
              <p className="scroll-reveal-target font-sans text-[16px] sm:text-[18px] leading-[1.8] text-white">
          ...
          <div className="flex flex-col items-center text-center w-full mb-16">
            ...
            <h2 className="scroll-reveal-target font-serif text-[42px] sm:text-[52px] font-medium leading-[1.15] text-white tracking-tight mb-20">
              Key Features
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
              ...
              <div className="border border-white/20 bg-black p-8 rounded-[24px] flex flex-col justify-start text-left items-start hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300 hover:scale-[1.01]">
                ...
                <h3 className="scroll-reveal-target font-sans text-[19px] sm:text-[21px] font-semibold text-white tracking-tight mb-3">Workflow Automation</h3>
                <p className="scroll-reveal-target font-sans text-[14px] sm:text-[15px] leading-relaxed text-white">Automate complex business workflows with intelligent triggers, conditions, and actions.</p>
              </div>
              ...
              <div className="border border-white/20 bg-black p-8 rounded-[24px] flex flex-col justify-start text-left items-start hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300 hover:scale-[1.01]">
                ...
                <h3 className="scroll-reveal-target font-sans text-[19px] sm:text-[21px] font-semibold text-white tracking-tight mb-3">Task Automation</h3>
                <p className="scroll-reveal-target font-sans text-[14px] sm:text-[15px] leading-relaxed text-white">Eliminate repetitive manual tasks and let smart systems handle routine operations.</p>
              </div>
              ...
              <div className="border border-white/20 bg-black p-8 rounded-[24px] flex flex-col justify-start text-left items-start hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300 hover:scale-[1.01]">
                ...
                <h3 className="scroll-reveal-target font-sans text-[19px] sm:text-[21px] font-semibold text-white tracking-tight mb-3">Approval Flows</h3>
                <p className="scroll-reveal-target font-sans text-[14px] sm:text-[15px] leading-relaxed text-white">Streamline multi-level approval processes with automated routing and notifications.</p>
              </div>
              ...
              <div className="border border-white/20 bg-black p-8 rounded-[24px] flex flex-col justify-start text-left items-start hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300 hover:scale-[1.01]">
                ...
                <h3 className="scroll-reveal-target font-sans text-[19px] sm:text-[21px] font-semibold text-white tracking-tight mb-3">Smart Notifications</h3>
                <p className="scroll-reveal-target font-sans text-[14px] sm:text-[15px] leading-relaxed text-white">Trigger automated alerts and notifications based on business events and deadlines.</p>
              </div>
              ...
              <div className="border border-white/20 bg-black p-8 rounded-[24px] flex flex-col justify-start text-left items-start hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300 hover:scale-[1.01]">
                ...
                <h3 className="scroll-reveal-target font-sans text-[19px] sm:text-[21px] font-semibold text-white tracking-tight mb-3">Process Tracking</h3>
                <p className="scroll-reveal-target font-sans text-[14px] sm:text-[15px] leading-relaxed text-white">Monitor automated processes in real-time with detailed logs and performance metrics.</p>
              </div>
              ...
              <div className="border border-white/20 bg-black p-8 rounded-[24px] flex flex-col justify-start text-left items-start hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300 hover:scale-[1.01]">
                ...
                <h3 className="scroll-reveal-target font-sans text-[19px] sm:text-[21px] font-semibold text-white tracking-tight mb-3">Automated Reports</h3>
                <p className="scroll-reveal-target font-sans text-[14px] sm:text-[15px] leading-relaxed text-white">Generate and distribute business reports automatically on schedule or by trigger.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="automation-page-3" className="w-full bg-black min-h-[calc(100vh-6rem)] py-12 flex flex-col justify-center items-center">
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full flex flex-col justify-between items-center animate-fade-in">
          ...
          <div className="flex flex-col items-center text-center mb-16 w-full">
            ...
            <h2 className="scroll-reveal-target font-serif text-[42px] sm:text-[52px] font-medium leading-[1.15] text-white tracking-tight mb-16">
              Business Benefits
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-4 w-full relative z-10">
              {[
                ...
                <div key={idx} className="flex flex-col items-center text-center space-y-6">
                  <div className="w-11 h-11 rounded-full border border-white/20 bg-black flex items-center justify-center text-white font-semibold text-[16px] shadow-[0_0_15px_rgba(255,255,255,0.05)] select-none">
                    {item.step}
                  </div>
                  <div className="w-full border border-white/20 bg-black px-4 py-4 rounded-[18px] min-h-[96px] flex items-center justify-center hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300">
                    <p className="scroll-reveal-target font-sans text-[13px] sm:text-[14px] leading-relaxed font-medium text-white">
                      {item.text}
                    </p>
                  </div>
                </div>
