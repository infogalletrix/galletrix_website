...
const Web: React.FC<WebProps> = ({ navigateToContact }) => {
  return (
    <>
      {/* Web Page 1: Hero */}
      <section id="web" className="w-full bg-black mt-24 py-12 flex flex-col justify-center min-h-[calc(100vh-6rem)]">
      ...
      <section id="web-page-2" className="w-full bg-black min-h-[calc(100vh-6rem)] py-12 border-t border-slate-900/60 flex flex-col justify-center items-center">
          ...
          <div className="flex flex-col items-center text-center w-full mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
              ...
              <div className="border border-white/20 bg-black p-8 rounded-[24px] flex flex-col justify-start text-left items-start hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300 hover:scale-[1.01]">
                ...
                <h3 className="scroll-reveal-target font-sans text-[19px] sm:text-[21px] font-semibold text-white tracking-tight mb-3">Custom Web Applications</h3>
                <p className="scroll-reveal-target font-sans text-[14px] sm:text-[15px] leading-relaxed text-white">Tailored web platforms built to solve specific business challenges and support growth.</p>
              </div>
              ...
              <div className="border border-white/20 bg-black p-8 rounded-[24px] flex flex-col justify-start text-left items-start hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300 hover:scale-[1.01]">
                ...
                <h3 className="scroll-reveal-target font-sans text-[19px] sm:text-[21px] font-semibold text-white tracking-tight mb-3">Admin Dashboards</h3>
                <p className="scroll-reveal-target font-sans text-[14px] sm:text-[15px] leading-relaxed text-white">Powerful admin panels to manage content, users, data, and business operations.</p>
              </div>
              ...
              <div className="border border-white/20 bg-black p-8 rounded-[24px] flex flex-col justify-start text-left items-start hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300 hover:scale-[1.01]">
                ...
                <h3 className="scroll-reveal-target font-sans text-[19px] sm:text-[21px] font-semibold text-white tracking-tight mb-3">Responsive Design</h3>
                <p className="scroll-reveal-target font-sans text-[14px] sm:text-[15px] leading-relaxed text-white">Pixel-perfect interfaces that work flawlessly across desktop, tablet, and mobile devices.</p>
              </div>
              ...
              <div className="border border-white/20 bg-black p-8 rounded-[24px] flex flex-col justify-start text-left items-start hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300 hover:scale-[1.01]">
                ...
                <h3 className="scroll-reveal-target font-sans text-[19px] sm:text-[21px] font-semibold text-white tracking-tight mb-3">Secure Architecture</h3>
                <p className="scroll-reveal-target font-sans text-[14px] sm:text-[15px] leading-relaxed text-white">Enterprise-grade security with encrypted data, authentication, and access controls.</p>
              </div>
              ...
              <div className="border border-white/20 bg-black p-8 rounded-[24px] flex flex-col justify-start text-left items-start hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300 hover:scale-[1.01]">
                ...
                <h3 className="scroll-reveal-target font-sans text-[19px] sm:text-[21px] font-semibold text-white tracking-tight mb-3">API Integration</h3>
                <p className="scroll-reveal-target font-sans text-[14px] sm:text-[15px] leading-relaxed text-white">Seamless integration with third-party services, payment gateways, and business tools.</p>
              </div>
              ...
              <div className="border border-white/20 bg-black p-8 rounded-[24px] flex flex-col justify-start text-left items-start hover:border-white/40 hover:bg-[#0a0a0a] transition-all duration-300 hover:scale-[1.01]">
                ...
                <h3 className="scroll-reveal-target font-sans text-[19px] sm:text-[21px] font-semibold text-white tracking-tight mb-3">Performance Optimization</h3>
                <p className="scroll-reveal-target font-sans text-[14px] sm:text-[15px] leading-relaxed text-white">Lightning-fast load times and smooth interactions through optimized code and architecture.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="web-page-3" className="w-full bg-black min-h-[calc(100vh-6rem)] py-12 flex flex-col justify-center items-center">
