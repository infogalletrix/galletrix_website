...
const Finance: React.FC<FinanceProps> = ({ navigateToContact }) => {
  ...
  return (
    <>
      {/* Hero Section */}
      <section id="finance-hero" className="w-full bg-black mt-24 py-12 flex flex-col justify-center min-h-[calc(100vh-6rem)]">
      ...
      <section id="finance-landscape" className="w-full bg-black py-16 md:py-32 border-t border-slate-900/60 flex flex-col items-center">
      ...
      <section id="finance-what-we-build" className="w-full bg-black py-16 md:py-32 border-t border-slate-900/60 flex flex-col items-center">
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full">
      ...
      <section id="finance-benefits" className="w-full bg-black py-16 md:py-32 border-t border-slate-900/60 flex flex-col items-center">
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full">
          <div className="flex flex-col items-center text-center mb-16">
            <span className="font-sans text-[15px] font-semibold tracking-wide text-white/50 mb-4 uppercase">
              Advantages
      ...
      <section id="finance-reality" className="w-full bg-black py-16 md:py-32 border-t border-slate-900/60 flex flex-col items-center">
